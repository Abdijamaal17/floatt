...
export async function proxy(request: NextRequest) {
  ...
  try {
    ...
    // If middleware throws for any reason, pass the request through
    // rather than returning a 500. Auth checks will still happen in
    // individual route handlers / layouts.
